...
public class PlayerTest {
	...
	@Test
	public void switchWeaponTest() throws FactoryException {
		IPlayer p1;
		p1 = new Player("p1");
		IWeapon sniper = WeaponsFactory.createWeapon(WeaponsDirectory.SNIPER);
		p1. grantWeapon(sniper);
		p1.switchWeapon(2);

		Assert.assertTrue(p1.getWeaponEquipped().equals(sniper));
	}
/*
	@Test
	public void buyItemTest() throws FactoryException {
		IPlayer p1 = new Player("p1");

		p1.grantGold(500);
		p1.buyItem(Weapon Weapon);
